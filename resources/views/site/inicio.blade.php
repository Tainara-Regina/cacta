...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        function(data, status){
         ...
         $(".vagas").append("<a href='{{route('site.vaga')}}'><div class='row text-center py-3' style='border-bottom: 1px solid #bdbdbd'><div class='col d-none d-sm-block'><img width='125px' src='https://cdn.pixabay.com/photo/2018/04/05/02/52/room-3291779__340.jpg'></div><div class='col'><p><b>Barbeiro</b></p><p>Barbearia Dona Navalha</p></div><div class='col'><p><b>Fixo</b></p><p>São Paulo</p></div><div class='col mt-4'><p class='vaga-destaque'>Destaque</p></div></div></a>");  
