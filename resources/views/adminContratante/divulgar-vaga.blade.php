					...
					<div class="col">
						<div class="card card-inverse card-danger">
							<div class="card-block bg-dark text-center">
								...
								<h1 class="display-1">1<span style="font-size: 34px">/2</span></h1>
							</div>
						</div>
					</div>
						...
						<form action="{{route('site.cadastrar-vaga')}}" method="POST">
							...
							<div class="form-check mb-5">
								<label class="form-check-label" for="check1">
									<input name="destaque" type="checkbox" class="form-check-input" id="check1" name="option1" value="something" >Deixar vaga em destaque?
								</label>
							</div>
